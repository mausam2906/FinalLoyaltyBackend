...
var Server = (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response && response.records && response.records[0]) {
                            return [2, response.records[0].base_fee_in_stroops || 100];
                        }
                        return [2, 100];
                }
            });
    ...
    Server.prototype.offers = function (resource) {
        ...
        return new (offer_call_builder_1.OfferCallBuilder.bind.apply(offer_call_builder_1.OfferCallBuilder, [void 0, urijs_1.default(this.serverURL),
            resource].concat(resourceParams)))();
    };
